...
urlpatterns = [
        ...
        url(r'^assignment/(?P<assignment_id>[0-9]+)/setparent/$',
            views.assignment_setparent,
            name="assignment_setparent"),
        url(r'^assignment/(?P<assignment_id>[0-9]+)/subtasks/$',
            views.assignment_subtasks,
            name="assignment_subtasks"),
